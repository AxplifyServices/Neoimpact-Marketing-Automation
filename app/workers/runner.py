...
def main() -> int:
    ...
    if not role:
        print("usage: python -m app.workers.runner <campaign|outbound|inbound|batch|segmentation|attrition|digital_engagement|best_channel|commercial_pressure>", file=sys.stderr)
        return 2
