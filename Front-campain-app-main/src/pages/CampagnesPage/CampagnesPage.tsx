...
export default function CampagnesPage() {
  ...
  const handleOpenWorkflow = (campaign: any) => {
    setWorkflowModal({
      ...
      listeActionJson: campaign.modelData?.listeAction || '[]',
      variableCible: campaign.modelData?.variableCible || '',
      objectif: campaign.modelData?.objectif || '',
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-3 sm:p-4 lg:p-6 pt-16 lg:pt-6">
      ...
      <WorkflowModal
        ...
        listeActionJson={workflowModal.listeActionJson || '[]'}
        variableCible={workflowModal.variableCible || ''}
        objectif={workflowModal.objectif || ''}
        campaignTitle={workflowModal.campaignTitle || ''}
      />
