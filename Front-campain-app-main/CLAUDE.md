...
- **Components** (`src/components/`) - Reusable UI components
  ...
  - `custom/` - Application-specific components (CampaignGraph, WorkflowVisualization, etc.)
...
Campaign models are visualized using ReactFlow/XYFlow:
- `src/components/custom/WorkflowVisualization.tsx` - Main visualization component
- `src/components/custom/WorkflowPreview.tsx` - Preview mode
...
- **Mock data** available via `VITE_ENABLE_MOCK_DATA=true` (see `src/lib/api/mock/`)
