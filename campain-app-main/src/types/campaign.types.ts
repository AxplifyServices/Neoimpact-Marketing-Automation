export type TypeCampagne = 'sans_action_terrain' | 'avec_action_terrain';

export type VisitMode = 'TERRAIN' | 'A_DISTANCE';

export type VisitPurpose = 'COMMERCIAL' | 'RECOUVREMENT';

export type QueueType = 'crc' | 'da' | 'cc';
